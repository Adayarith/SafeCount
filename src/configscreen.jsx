...
const ConfigScreen = () => {
  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-gradient-to-b from-[#faf3fa] to-[#90dffe]">
      {/* este es fondo de las pantallas*/}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-[-50px] right-[-50px] w-40 h-40 bg-yellow-300 rounded-full opacity-90" />
        <div className="absolute bottom-10 right-10 w-52 h-52 bg-blue-200 rounded-full opacity-80" />
        <div className="absolute top-1/3 left-[-30px] w-48 h-48 bg-blue-300 rounded-full opacity-80" />
      </div>
      ...
      <div className="relative z-10">
        ...
        <main className="flex-grow flex items-center justify-center p-4 relative">
          <div className="w-full max-w-lg p-8 bg-white rounded-xl shadow-lg relative z-10">
